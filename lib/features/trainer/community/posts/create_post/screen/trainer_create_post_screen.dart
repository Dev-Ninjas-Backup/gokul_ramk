...
import 'package:gokul_ramk/features/trainer/community/posts/create_post/controller/trainer_create_post_controller.dart';
import 'package:gokul_ramk/features/trainer/community/posts/create_post/widget/post_content_text_field.dart';

class TrainerCreatePostScreen extends StatelessWidget {
  final TrainerCreatePostController controller = Get.put(
    TrainerCreatePostController(),
  );

  TrainerCreatePostScreen({super.key});
