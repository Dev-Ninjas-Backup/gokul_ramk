class Product {
  ...
  static Map<String, dynamic> _parseIngredients(dynamic ingredients) {
    if (ingredients is Map<String, dynamic>) {
      ...
      // If it's a string, return empty map (it might be stored as JSON string)
      return {};
    }
    return {};
  }
...
class Owner {
  ...
  Map<String, dynamic> toJson() {
    return {'fullname': fullname, 'images': images, 'email': email};
  }
}
...
class Category {
  ...
  Map<String, dynamic> toJson() {
    return {'name': name, 'color': color, 'imageUrl': imageUrl};
  }
}
