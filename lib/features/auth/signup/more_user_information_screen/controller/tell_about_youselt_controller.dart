...
import 'package:gokul_ramk/features/auth/signup/more_user_information_screen/model/goal_model.dart';
import 'package:gokul_ramk/features/auth/signup/more_user_information_screen/model/trining_days_model.dart';
import 'package:gokul_ramk/features/auth/signup/more_user_information_screen/services/services.dart';
...
class TellAboutYouseltController extends GetxController {
  ...
  final heartCondition = false.obs;
  final chestPain = false.obs;
  final medication = false.obs;
  final hasInjuries = false.obs;
  final hasDizziness = false.obs;
  final hasSurgery = false.obs;
  ...
  void selectTrainingDay(int index) {
    for (var i = 0; i < trainingDays.length; i++) {
      trainingDays[i].isSelected = i == index;
    }
    trainingDays.refresh();
  }
