...
// import '../model/availability_item.dart';
...
//     final bioVal = bioController.text.trim().isEmpty ? currentBio.value : bioController.text.trim();
...
//           url: "https://yourapi.com/api/upload",
...
//           }
//         } else {
//           EasyLoading.showError(uploadRes.errorMessage ?? 'Image upload failed');
//           return;
//         }
//       }
...
//         url: "https://yourapi.com/api/trainer/profile",
//         body: payload,
//       );
...
class TellAboutTrainerController extends GetxController {
  ...
  Map<String, dynamic> buildPayload() {
    ...
    final bioVal = bioController.text.trim().isEmpty
        ...
        final finalImageUrl = selectedImage.value != null ? Urls.baseUrl + imageUrl.value : " ";
